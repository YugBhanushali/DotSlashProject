...
export const TreeContextWrapper = ({children}) => {
  ...
  return (
    <TreeContext.Provider value={{nodes,setNodes,onNodesChange,edges,setEdges,onEdgesChange,tempEdges, setTempEdges,tempNode, setTempNode}}>
        {children}
    </TreeContext.Provider>
  )
}

export const TreeGlobalContext = () =>{
